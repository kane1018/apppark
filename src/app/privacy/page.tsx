  ...
  return (
    ...
    >
      <div className="prose-legal">
        ...
        <h2>1の3. アイデア掲示板に関して取得する情報</h2>
        <p>
          アイデア掲示板（アイデア投稿・コメント・共感ボタン・「作ってみたい」ボタン）の提供・管理のため、以下の情報を取得する場合があります。
        </p>
        <ul>
          <li>投稿アイデアの内容</li>
          <li>アイデアへのコメント</li>
          <li>共感（「これ欲しい」）したアイデア</li>
          <li>「作ってみたい」の意思表示</li>
          <li>アイデアと関連サービスの紐付け情報</li>
          <li>投稿者ID・公開表示名</li>
        </ul>
        <p>
          <strong className="font-semibold text-ink">公開される情報：</strong>
          投稿アイデアの内容／コメント内容／公開表示名（匿名投稿を選んだ場合は「匿名」と表示）。
        </p>
